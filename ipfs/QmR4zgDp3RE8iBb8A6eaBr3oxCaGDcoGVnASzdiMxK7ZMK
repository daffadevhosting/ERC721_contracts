...
contract SimPL is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    ...
    constructor() ERC721("SimPL", "SimPL") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://sendaljepit.konek.web.id";
    }
